...
public class LoginScreen extends Widget {
	...
	public LoginScreen(Widget parent) {
		...
		new Img(new Coord(400, -60).add(logo.sz().div(2).inv()), logo, this);
		instance = this;
		spawnLoginButtons();
	}
	...
	private class Pwbox extends Login {
		...
		private Pwbox(String username, boolean save) {
			...
			setfocustab(true);
			new Label(new Coord(0, 0), this, "Username:", textf);
			...
			pass.pw = true;
			savepass = new CheckBox(new Coord(0, 110), this, "Save Login");
			savepass.a = save;
			if (user.text.equals(""))
				setfocus(user);
			else
