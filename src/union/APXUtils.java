...
public class APXUtils {
	...
	public static Resource buddyRes = Resource
			.load("paginae/union/buddy"); //friend
	...
	public static void addMenu() {
		...
		scriptRoot = new MenuElement(null,
				new String[] { CustomMenu.menu_prefix }, resScript2, "Script Menu",
				"Open Script Menu", 'S', "script_root");
		...
		scriptRootNew = addResource("script_start", "Activate Scripts",
				"Opens Available Scripts", 'A',
				resScript2, scriptRoot, new MenuElemetUseListener(null) {
					public void use(int button) {
						if (button == 1) {
		...
		scriptRootRem = addResource("script_stop", "Manage Running Scripts",
		...
		addResource("stop_all_scripts", "Stop All Scripts",
				"Stops All Running Scripts", 'S', resScript5, scriptRoot,
				new MenuElemetUseListener(null) {
					public void use(int button) {
		...
		addResource("hide_all_objects", "Hide Everything", "Hides ALL", 'H', resScript2, unionRoot,
				new MenuElemetUseListener(null) {
					public void use(int button) {
		...
		addResource("stop_self_moving", "Stop Moving",
				"Stops Character Movement", 'm', resScript2, unionRoot,
				new MenuElemetUseListener(null) {
					public void use(int button) {
						_add_stop_movement();
					}
